  ...
  return (
    <html lang="en">
      <body className={`${inter.className} bg-gray-50 text-gray-900`}>
        <header className="w-full bg-grey-600 text-black p-4 shadow-md">
          <h1 className="text-xl font-semibold">Quote Genertaor</h1>
        </header>
        <main className="container mx-auto p-6">{children}</main>
        <footer className="w-full text-center text-sm text-gray-500 py-4 border-t">
          © {new Date().getFullYear()} Quotes Generator. All rights reserved.
        </footer>
      </body>
    </html>
  )
